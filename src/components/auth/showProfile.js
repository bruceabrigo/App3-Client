...
const ShowProfile = (props) => {
    //  show content cards that belong to the user who is logged in
    ...
    console.log('User in Index Card: ', user)
    useEffect(() => {
        getAllContent()
    ...
    const userContent = content.reverse().map(content => (
        <Card key={content._id} className='mb-4'>
          {
            ...
            <Card.Body>
                ...
                <Card.Text className='pb-5 pt-5 border-bottom'>
                    {content.material}
                </Card.Text>
                <Card.Text>
